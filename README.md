...
目前整个项目暂时完成，目前还是有一些小Bug，存在Bug的代码文件是/View/HOMEPage.xaml.cs，本人实在是不会修了，最近我打算摆烂去追番去了，如果各位有什么校园恋爱后宫搞笑类型的番剧可以在B站私信我，谢谢ヾ(≧▽≦*)o，当然如果各位有什么能修复Bug的代码也可以提交，我会在感谢名单里写上你的名字的( •̀ ω •́ )✧
